...
Syzygy is a cross-platform mobile ecosystem — production-ready UI, extension, and core service libraries, plus starter templates, spanning iOS, Android, React Native, and Flutter.
...
### UI Libraries
Component libraries with design tokens and dark mode support.
...
### Base Templates
Production-ready starter templates with Clean Architecture and CI/CD.
...
### Shared Tooling
- [syzygy-lint-config](https://github.com/Syzygy-Hub/syzygy-lint-config) — Shared lint/format configs across all platforms
- [syzygy-brand-assets](https://github.com/Syzygy-Hub/syzygy-brand-assets) — Logo, icon, banners, and brand guidelines
