...
Brand assets — logo, icon, banners, and color palette — are hosted in this repository under [`Assets/`](Assets/). See [BRAND_GUIDE.md](BRAND_GUIDE.md) for usage guidelines, clear space rules, minimum sizes, and correct/incorrect usage examples.
